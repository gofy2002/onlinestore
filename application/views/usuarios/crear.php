    	...
    	<?php echo form_open('',array( 'data-toggle' => 'validator', 'role' => 'form') ); ?>
			...
			<div class="row">
				...
				<div class="col-xs-8 col-sm-9 col-md-9">
					 By clicking <strong class="label label-primary">Registrar</strong>, you agree to the <a href="#" data-toggle="modal" data-target="#t_and_c_m">Terminos y Condiciones</a> set out by this site, including our Cookie Use.
				</div>
			</div>
